int learn()
{
  ...
  printf("Types of constants are followes:\n");
  ...
  printf("\n Integer constants :\n");
  printf("    Integer constants are whole number without any fractional part. Thus integer constant consist of a seqence of digits.\n Integer constant can be written in three different number systems:\nDecimal, Octal and hexadecimal.\n");
  ...
  printf("     \tThese constants must have  the digits along with the decimal pont and it can  be either positive or negative.\n"):
  printf("Examples :\n 3.142, 4.35, -1.234 etc\n");
  printf("\n Octal constants :\n");
  ...
  printf("    \tA hexadecimal integer  constant must begin either 0x or ox.It can then be follwed by any combinations of digitstaken from set 0 through 9 and A through F(either uppercase or lowercase)."\n");
  printf("The following valid hexadecimal integer constants.\nExamples :\t 0x0, -0x55, -0x12 etc.\n");
  printf("\n Character constant :\n");
  printf("     \tThese constant are single alphabet, single digit or singlee special symbol enclosed within single quotes.\n");
